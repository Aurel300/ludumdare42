...
class Interactive {
  public static var INDEX:Map<String, Interactive> = [
    ...
    ,"slick" => new Interactive([
        ...
        ,Text('In fact, without using the maintenance shaft, this faucet is now completely unreachable from either end of the room, all because of the oil -----.')
        ,Take(["slick"])
      ])
    ...
    ,"ss3" => new Interactive([
        ...
        ,Text('"If I were up to scracth, they would call my score ... What! I can\'t think of the proper word for the life of me."')
        ,Text('You suggest to the synonym seeker ...')
        ,Give(["par"])
    ...
    ,"bouncer" => new Interactive([
        ...
        ,Text('"A black cat sleeps in the middle of a road in a town painted black. None of the street lights work due to a power failure caused by the storm. A car with broken headlights drives towards the cat but turns in time to avoid it. How could the driver have seen the cat?"')
